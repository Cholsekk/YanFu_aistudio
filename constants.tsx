...
export const SYSTEM_ICONS = [
  ...
  { name: 'Users', bgColor: 'bg-primary-600' },
  ...
  { name: 'ClipboardList', bgColor: 'bg-primary-500' },
  { name: 'Box', bgColor: 'bg-primary-600' },
  { name: 'ImageIcon', bgColor: 'bg-orange-500' },
  { name: 'Mail', bgColor: 'bg-primary-500' },
  { name: 'MapPin', bgColor: 'bg-green-500' },
  { name: 'Shield', bgColor: 'bg-primary-600' },
  ...
  { name: 'Heart', bgColor: 'bg-primary-600' },
  { name: 'Settings', bgColor: 'bg-primary-500' },
